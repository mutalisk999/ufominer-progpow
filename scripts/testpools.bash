...
#
# Testscript to test ufominer multiple pools/hosts/syntaxes
# Put this script in the bin directory of ufominer and start running
#
...
# export some vars as "./ufominer" could be still a wrapper script
...
for pool in $POOLS; do
    ...
    echo "./ufominer -v 1 --exit --report-hashrate -P $pool $@"
    echo "./ufominer -v 1 --exit --report-hashrate -P $pool $@" > log.txt
    ./ufominer -v 1 --exit --report-hashrate -P $pool $@ >> log.txt 2>&1 &
    pid=$!
    #echo "PID=$pid"
