...
cmake -G "Visual Studio 15 2017 Win64" -H. -Bbuild_opencl -T v140 -DCUDA=OFF -DCPU=ON -DCUDA_TOOLKIT_ROOT_DIR="'C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v9.1'" ..
